...
export default function MagicLinkForm({ callbackURL = "/my-events" }) {
	...
	return (
		...
		>
			<div className="space-y-2 text-center">
				<h2 className="font-display text-2xl tracking-tight">Sign in to your portal</h2>
				<p className="text-sm text-muted-foreground">
					Pop your email in. We'll send a one-click sign-in link — no password needed.
				</p>
			</div>
