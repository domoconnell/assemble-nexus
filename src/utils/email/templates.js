...
export const EMAIL_TEMPLATES = {
	...
	"booking-enquiry-received": {
		...
		fields: {
			...
			view_url: "Public link to /booking-received/[id] — the minimal post-submit landing the customer sees pre-sign-in.",
		},
	},
	...
	"booking-approved": {
		...
		fields: {
			...
			view_url: "Public link to /booking-received/[id] — landing page with a CTA to /my-bookings/[id] for the full breakdown.",
			pay_deposit_url: "When a deposit is required: link to /booking-received/[id]. Empty when no deposit.",
	...
	"booking-balance-invoice": {
		...
		fields: {
			...
			view_url: "Link to /booking-received/[id].",
		},
	},
	...
	"booking-deposit-paid": {
		...
		fields: {
			...
			view_url: "Public link to /booking-received/[id].",
		},
	},
